...
MacrorMainWindow::MacrorMainWindow(QWidget *parent,
    ...
    modelsWindow(new ABC_ObjectsWindow
                 (cm,Markov_Mol_New::ABC_Markov_Model::ClassName(),parent)),
    patchsWindow(new ABC_ObjectsWindow
                 (cm,Markov_Mol_New::ABC_PatchModel::ClassName(),parent)),
    experimentsWindow(new ABC_ObjectsWindow
                      (cm,Markov_IO_New::ABC_Experiment::ClassName(),parent)),
    //graphWindows(),
    cm_(cm)
{
    createActions();
