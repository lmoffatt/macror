...
namespace Markov_Console
{
  ...
  void swap(Token& one,Token& other)
  {
    std::swap(one.curr_tok,other.curr_tok);
    std::swap(one.number_value,other.number_value);
    std::swap(one.identifier_value,other.identifier_value);
    std::swap(one.path_value,other.path_value);
    std::swap(one.emptyString_,other.emptyString_);
