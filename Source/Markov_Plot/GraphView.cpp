...
namespace Markov_Plot
{
  GraphView::GraphView(QWidget* parent,
                       Markov_IO::ABC_Environment_Var* e,
                       qreal width,
                       qreal height):
  ...
  GraphView* aplot(QWidget* parent,Markov_IO::ABC_Environment_Var* e,
  ...
  GraphView* aplot(QWidget* parent, Markov_IO::ABC_Environment_Var *e, const Markov_IO::ABC_trace& trace)
  {
