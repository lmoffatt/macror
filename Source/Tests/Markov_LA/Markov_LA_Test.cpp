...
template<typename T>
MultipleTests Markov_LA_Test<T>::All_Tests()
{
    ...
    result.push_back(mdTest.All_Tests());

    Matrix_Test<std::size_t> msTest;
    result.push_back(msTest.All_Tests());
    ToleranceComparison_Test tTest;
    result.push_back(tTest.All_Tests());
    return result;
...
template<typename T>
Markov_LA_Test<T>::Markov_LA_Test():
    M_(){}

template<typename T>
Markov_LA_Test<T>::Markov_LA_Test(
    const Markov_LA_Test& other):
    M_(other.M_){}

template<typename T>
Markov_LA_Test<T>::Markov_LA_Test(const M_Matrix<T>& sample):
    M_(sample){}

template<typename T>
Markov_LA_Test<T>::Markov_LA_Test(std::size_t size):
    M_(Rand<T>(size,size,0)){}



template class Markov_LA_Test<double>;
