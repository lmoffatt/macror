...
namespace Markov_Test
{
  ...
  namespace Markov_Bay_Test
  {
    ...
    std::string Markov_Bay_Test::TestName()
    {
      return "Markov_Bay_Test";
    }

    std::string Markov_Bay_Test::myTest()const
    {
      return TestName();
    }
    ...
    std::string Markov_Bay_Test::testedClass()const
    {
      return Markov_Mol::ABC_PatchModel::ClassName();
    }


    MultipleTests Markov_Bay_Test::AllTests(Markov_Console::Markov_CommandManager* cm, const std::string varNameTested)
    {
      ...
      result.push_back(ABC_Markov_Likelihood_step_Test(
                         Macro_DR_step(patch_,true)).AllTests(cm,varNameTested));



      result.push_back(ABC_Markov_Likelihood_step_Test(
                         Macro_DR_step(patch_,false)).AllTests(cm,varNameTested));
