...
class MacrorVarEditWindow: public QDialog
{
    Q_OBJECT
public:
    ...
    const Markov_IO::ABC_Data *getFieldObject(QString fieldName)const;
    ...
    bool replaceField(QString fieldName,const Markov_IO::ABC_Data* newObject);


    void setFieldObject(Markov_IO::ABC_Data* obj);
...
private:
     ...
     const Markov_IO::ABC_Data* v_old;
