...
*/
    ...
    namespace _private
    {
        ...
        public:
          ...
          virtual const Implements_Data_Type_New<K>* getKeyType()const=0;

          virtual const Implements_Data_Type_New<T>* getElementType()const=0;
          ...
          virtual buildByToken<T>* getElementBuildByToken(const StructureEnv_New* cm)const
          {
              const Implements_Data_Type_New<T>* v= this->getElementType();
              if (v!=nullptr)
                  return new buildByToken<T>(cm,v);
              else return nullptr;
          }
          ...
          {
              const Implements_Data_Type_New<K>* v= this->getKeyType();
              if (v!=nullptr)
    ...
    namespace _private {
        ...
        public:
            ...
            virtual const Implements_Identifier* getKeyType()const
            {
                return idType_;
            }
            ...
            virtual const Implements_Data_Type_New<ABC_Data_New*>* getElementType()const
            {
                return dataType_;
            }
