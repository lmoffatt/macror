...
*/
    ...
    public:
        ...
        enum DAF {S_Init,S_Header2,S_Header_Final,S_Data_Partial,S_Data_Final,S_Data_Separator_Final,S_Final} ;
    ...
    public:
        ...
        build_Command_Input(
                ...
                , const Implements_Data_Type_New<std::__cxx11::string> *idCmd);
